...
To read off the explicit formula for $\E{L_h}$ the generating function must be expanded back into a power series. To do so we write it in the form of a geometric sum.
\begin{align}
